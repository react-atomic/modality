...
function isSafePattern(text: string, content?: string, lineNumber?: number): boolean {
...
export function detectAPIKeyLeaks(content: string): Array<{ line: number; match: string; pattern: string }> {
